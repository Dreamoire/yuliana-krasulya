      ...
      <main className="home-page page-container">
        <section className="intro">
          ...
          <div className="intro-text">
            <h1>
              Développeur web <br />
              front-end / full stack (en formation)
            </h1>

            <p>
              Issu d’un parcours en création visuelle, je mets aujourd’hui mon sens du design,
              de la précision et du détail au service du développement web.
              <br />
              En formation à la Wild Code School, je développe des applications web en JavaScript,
              React et TypeScript, en appliquant des méthodes professionnelles basées sur les
              pratiques Agile et Scrum.
              <br />
              Je construis un parcours professionnel durable, en mettant l’accent sur la qualité
              du code, la fiabilité et la collaboration en équipe.
            </p>
          </div>
        </section>
